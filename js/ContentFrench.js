...
function getResponse_French(){
	...
	if(len >= 100) {
		var url = 'https://customerdeepinsights.mybluemix.net/FrenchPersonalityInsights';
		var txt={};
		txt.data = input_text;
