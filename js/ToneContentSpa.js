...
function addToneContentSpanish() {
...
// create Div element
   ...
   p.setAttribute('align', 'center');
    ...
    submit_Eng.onclick = getToneResponse_Spa;
...
function getToneResponse_Spa(){
	var input_text = input.value;
	var url = 'https://customerdeepinsights.mybluemix.net/SpanishToneAnalyze';
	var txt={};
	txt.data = input_text;
