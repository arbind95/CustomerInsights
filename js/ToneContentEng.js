...
// create Div element
   ...
   p.setAttribute('align', 'center');
    ...
    submit_Eng.onclick = getToneResponse_Eng;
...
function getToneResponse_Eng(){
	var input_text = input.value;
	var url = 'https://customerdeepinsights.mybluemix.net/ToneAnalyze';
	var txt={};
	txt.data = input_text;
